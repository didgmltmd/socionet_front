...
const locationInfo = {
  ...
  address: '부산광역시 해운대구 반송순환로 142, 영산대학교 해운대캠퍼스 M동 9층 903호',
}
const mapDefaults = {
  level: 3,
}
...
진성성을 갖고 의미를 만들며 가치를 창조하는 연구소가 될 수 있도록 여러분들의 많은 성원과 질책을 바랍니다. 감사합니다.
