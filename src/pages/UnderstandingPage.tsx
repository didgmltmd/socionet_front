...
const contentMap: Record<string, { title: string; text: string }> = {
  SOCIOMETRY: {
    title: 'SOCIOMETRY',
    text: `사회성측정법(sociomtric method)은 좋아함과 싫어함을 바탕으로 질문지를 만들고, 집단에 소속된 모든 구성원들이 N*N형태의 지명자와 피지명자가 되어 서로를 평가하는 방식으로 측정한다. 이 방법은 사이코드라마의 창시자인 Moreno라는 학자에 의해서 처음 시도 되었으며, 이런 방법을 통하여 집단에 소속된 구성원들의 개인적 특징과 사회적 상호작용 및 심리적 역동성을 파악하는 것이 가능하게 되었다.`,
  },
