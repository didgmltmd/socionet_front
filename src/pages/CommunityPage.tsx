...
일반상담 연구모임은 SOCIONET 연구 및 사례모임, TA(transactional analysis) 연구모임, 청소년과 TA모임, Carl Rogers의 인간중심상담(원서강독 가능) 모임, Adler상담 모임, 가족상담(원서강독 가능) 모임, 미술상담(원서강독 가능) 모임, 그리고 심리검사 연구모임을 위주로 한다.`
